...
public class AppointmentController {
    ...
    public ResponseEntity<Page<AppointmentResponse>> findAppointmentByDoctorIdAndDateRange(
        ...
        return ResponseEntity.status(HttpStatus.OK).body(appointmentService.findAppointmentByDoctorIdAndDateRange(id, appointmentDate, pageNumber, pageSize));
    }
    ...
    public ResponseEntity<Page<AppointmentResponse>> findAppointmentByAnimalIdAndDateRange(
        ...
        return ResponseEntity.ok().body(appointmentService.findAppointmentByAnimalIdAndDateRange(id, appointmentDate, pageNumber, pageSize));
    }
