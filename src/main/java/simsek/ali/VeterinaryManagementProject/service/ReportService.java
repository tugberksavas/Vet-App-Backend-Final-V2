...
public class ReportService {
    ...
    public ReportResponse createReport(ReportRequest reportRequest){
        ...
        Appointment appointmentFromDb = appointmentService.findAppointmenById(reportRequest.getAppointment().getId());
    ...
    public ReportResponse updateReport (Long id, ReportRequest reportRequest){
        ...
        Optional<Report> existOtherReportFromRequest =
                reportRepository.findReportByTitleAndDiagnosisAndPriceAndAppointmentId(reportRequest.getTitle(), reportRequest.getDiagnosis(), reportRequest.getPrice(), reportRequest.getAppointment().getId());
